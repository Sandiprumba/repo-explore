...
//onsearch props created at homepage
  ...
  return (
    <form className="max-w-xl mx-auto p-2 " onSubmit={(e) => onSearch(e, username)}>
      ...
      <div className="relative">
        ...
        <button
          type="submit"
          className="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 bg-gradient-to-r from-cyan-900 to-blue-900 hover:scale-90 transition-all duration-300"
        >
          Search
        </button>
      </div>
